...
const ShowTime = () => {
  ...
  return (
    <div className="bg-black p-11">
      <div>
        <h1 className="text-white text-2xl my-8">SHOW TIME</h1>
      </div>
      ...
      <div className="">
        {shows.map((shows)=> (
          <div className="text-white lg:flex  my-14 border border-gray-600 p-2" key={shows._id}>
            <div className="sm:flex ">
              <img className="" src={shows.image} alt="" />
            ...
            <div className="grid grid-cols-2 sm:flex lg:ml-10 mt-4 lg:mt-0">
              {shows?.shows?.map((shws,index)=> (
                <div key={index} className=" lg:mt-5 mt-1 border w-28 text-center p-1 m rounded-sm  hover:bg-white hover:text-black cursor-pointer sm:mr-2 lg:h-16 lg:mx-4">
